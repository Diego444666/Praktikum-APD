...
# Fungsi tambah parfum dengan parameter
def tambah_parfum():
    try:
        id_ = int(input("ID: "))
        if id_ in parfumes:
...
# Fungsi melihat deskripsi parfum
def lihat_deskripsi():
    try:
...
# Fungsi untuk menampilkan daftar parfum
