...
# print()
# # del data[2]
# # # data[0:2]  = ["mangga","semangka"]
# # nilai_hapus = data.pop (2)
# data.remove("apel")
# print(data)
...
import os
data_mahasiswa= ["fufu",  "fafu", "fafu", "fufu"] 
print(data_mahasiswa)
print()
data_mahasiswa[0:2]  = ["jako","wiwi"]
print(data_mahasiswa)
